...
export default function TopNav({ setIsProfilePopUpHandler ,isList , setIsList}) {
    return (
      <div className=" w-full rounded-lg sbg flex flex-row items-center p-4 gap-x-4 max-[520px]:rounded-none max-[520px]:p-2">
        <div className="flex items-center gap-x-1 caret-transparent">
        ...
        <img
          ...
          className="size-10 rounded-full min-[1001px]:hidden cursor-pointer object-cover"
