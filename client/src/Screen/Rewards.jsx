...
//                 <div className="w-[260px] p-4 rounded-lg  bg-orange-500 flex flex-col ">
//                   <div className=" flex flex-row items-center justify-center  mb-6 mt-2">
//                     <SiAmazon className="text-white text-5xl" />
//                   </div>
//                   <div className=" w-full relative">
//                     <div className=" w-full h-[6px] rounded-full bg-[rgba(255,255,255,0.5)] mb-4"></div>
//                     <div className=" absolute top-0 left-0 z-10 w-[33%] h-[6px] rounded-full bg-white mb-4"></div>
//                   </div>

//                   <div className="flex flex-row items-center text-sm justify-between">
//                     <div className=" th">$25</div>
//                     <div className=" tbg rounded-full flex flex-row items-center px-3 py-1 th">
//                       <PixIcon className=" th " sx={{ fontSize: 12 }} />
//                       1200
//                     </div>
//                   </div>
//                 </div>
