      ...
      <div className=" absolute bottom-[150px] left-20  max-[630px]:w-full px-4 max-[630px]:left-0 ">
        ...
        <div className="flex flex-col ">
          ...
          <div className="flex flex-row w-[550px] max-[630px]:w-full my-4">
            ...
            <div className="absolute top-[5px] right-[2px] cursor-pointer bg-white "><LocationOnIcon /></div>
            </div>
          ...
          <div className=" text-white font-medium text-sm">
            Or <span onClick={()=>navigate("/login")} className="text-lightMode-button cursor-pointer">Log in</span>
          </div>
        </div>
      </div>
    </div>
